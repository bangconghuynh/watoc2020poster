  ...
  \begin{column}{\dimexpr(2\colwidth+\sepwidth)}
    \begin{alertblock}{3. Challenges of Degenerate Systems}
      ...
      \begin{columns}[t]
        ...
        \begin{column}{\dimexpr(.65\colwidth)}
          \centering
          \begin{violethighlightbox}[height=15cm]{Symmetry of potential?}
        ...
        \begin{column}{\dimexpr(.65\colwidth)}
          \centering
          \begin{greenhighlightbox}[height=15cm]{Guarantee of $\symbfit{v}$-representability?}
            ...
            In particular:
            \begin{itemize}
              \item Is $\gls*{den:ground}[^{\symup{M}}_1]$ pure-state $v$-representable $\forall \lambda \in \interval{0}{1}$?
              ...
              \end{equation*}
              ensemble-state $v$-representable $\forall \lambda \in \interval{0}{1}$?
            \end{itemize}
%            Consider the pure-state degenerate density $\gls*{den:ground}[^{\symup{M}}_1]$.
%            \begin{enumerate}
%              \item Is $\gls*{den:ground}[^{\symup{M}}_1]$ non-interacting pure-state $v$-representable?
%              \item Is $\gls*{den:ground}[^{\symup{M}}_1]$ non-interacting ensemble-state $v$-representable?
%            \end{enumerate}
%
%            Consider now the following ensemble-state density $\gls*{den:ground}[^{\symup{M}}_{1, \symup{en}}]$:
%            \begin{equation*}
%              \gls*{den:ground}[^{\symup{M}}_{1, \symup{en}}] =
%              \frac{1}{\lvert \gls*{struct:gengroup}_1 \rvert}
%              \sum_{i=1}^{\lvert \gls*{struct:gengroup}_1 \rvert}
...
%            \begin{enumerate}
%              \setcounter{enumi}{2}
%              \item Is $\gls*{den:ground}[^{\symup{M}}_{1, \symup{en}}]$ non-interacting ensemble-state $v$-representable?
%            \end{enumerate}
